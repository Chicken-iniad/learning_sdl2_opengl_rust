        ...
        unsafe {
            ...
            imgui::Window::new(im_str!("Information"))
                ...
                .build(&ui, || {
                    ...
                    imgui::ProgressBar::new(mouse_pos[0] / 640f32)
                        .size([200.0, 20.0])
                        .overlay_text(im_str!("mouse-X"))
                        .build(&ui);
                    imgui::ProgressBar::new(mouse_pos[1] / 480f32)
                        .size([200.0, 20.0])
                        .overlay_text(im_str!("mouse-Y"))
                        .build(&ui);
                    let arr = [0.2, 0.4, 0.8, 0.1, 1.0, 0.7];
